...
public class CameraListView extends Activity {
    ...
    public String[] values = new String[]{
            ...
            "SIE AT BRADLEY AVENUE EXIT 12",
            "SIE AT CLOVE ROAD",
            "SIE AT FINGERBOARD ROAD",
            "SIE AT HYLAN BOULEVARD",
            "SIE AT RICHMON AVENUE",
            "SIE AT SLOSSON AVENUE",
            "SIE AT VICTORY BOULEVARD EOF EXIT 9",
            "SIE AT WOLLEY AVENUE WOD EXIT 11",
            "STREET JAMES Pl AT CHATHAM SQUARE",
            "THROGS NECK BRIDGE AT BRONX BOUND",
            "THROGS NECK BRIDGE AT QUEENS BOUND",
            "TRIBOROUGH BRIDGE BRONX BOUND",
            "TRIBOROUGH BRIDGE QUEENS BOUND",
            "TRIBOROUGH BRIDGEs AT MANHATTAN BOUND",
            "TRINITY AT BROOKLYN BATTERY TUNNEL",
            "VAN WYCK EXPY AT ATLANTIC",
            "VAN WYCK EXPY AT 101 AVENUE",
            "VAN WYCK EXPY AT BELT PARKWAY",
            "VAN WYCK EXPY AT GCP INTERCHANGE",
            "VAN WYCK EXPY S. OF LIE",
            "Varick STREET AT BEACH STREET",
            "VERRAZANO NARROWS AT BROOKLYN BOUND",
            "VERRAZANO NARROWS AT STREETaten Island BOUND",
            "VICTORY BOULEVARD AT BAY STREET",
            "VICTORY BOULEVARD AT JERSEY STREET",
            "VICTORY BOULEVARD WOF CAMPUS DR",
            "WBB BROOKLYN ENTRANCE",
            "WBB MANHATTAN ENTRANCE",
            "WEST BROADWAY AT CHAMBERS STREET",
            "WEST BROADWAY AT GRAND STREET",
            "WEST BROADWAY AT WORTH STREET",
            "WEST STREET AT 14 STREET",
            "WEST STREET AT 22 STREET",
            "WEST STREET AT 34 STREET",
            "WEST STREET AT 42 STREET",
            "WEST STREET AT CANAL STREET",
            "WEST STREET AT CLARCKSON",
            "WEST STREET AT HARRISON STREET",
            "WEST STREET AT INTREPID",
            "WHITESTONE AT 14 AVENUE",
            "WHITESTONE AT BRONX BOUND",
            "WHITESTONE AT QUEENS BOUND",
            "WHITESTONE BRIDGE",
            "WHITESTONE NEAR OF LINDEN PLAZA",
            "WORTH STREET AT CENTRE STREET",
            "WSE AT VICTORY BOULEVARD",
            "YORK AVENUE AT 91 ST"
    };
